...
from utils.image import load_image, get_sub_dir_image_paths
...
class Metrics:
    ...
    def _read_test_images(self):
        ...
        test_images = {}
        for brain_slice_path in get_sub_dir_image_paths(self.dataset_path):
    ...
    def compute(self, visualize: bool = False):
        ...
        atlas_embeddings = self._get_embedding(
            self.data_loader.avgt_images, self.model.get_model()
        )
